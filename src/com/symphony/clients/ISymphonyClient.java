...
public interface ISymphonyClient {
  ...
  V2RoomDetail roomDetailForId(String threadId);
  ...
  List<User> getUsersForEmailAddresses(List<String> emailAddresses);

  List<ISymphonyUser> getSymphonyUsersForEmailAddresses(List<String> emailAddresses);

  ISymphonyUser getSymphonyUserForEmailAddress(String emailAddress);
  ...
  String getRoomWithUsers(List<User> users, String roomName);
}